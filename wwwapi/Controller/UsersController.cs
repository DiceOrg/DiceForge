...
using wwwapi.Data;
using wwwapi.DataTransfer.Request;
using wwwapi.DataTransfer.Response;
using wwwapi.Enums;
using wwwapi.Models.Users;
using wwwapi.Models;
using wwwapi.Services;

namespace wwwapi.Controller
{
    [ApiController]
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(RegistrationRequest request)
        {
            ...
            var result = await _userManager.CreateAsync(
                new User { UserName = request.Username, Email = request.Email, Role = request.Role },
                request.Password!
            );
